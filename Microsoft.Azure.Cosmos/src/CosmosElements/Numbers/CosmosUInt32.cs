...
#pragma warning disable SA1601 // Partial elements should be documented
    ...
    abstract partial class CosmosUInt32 : CosmosNumber, IEquatable<CosmosUInt32>, IComparable<CosmosUInt32>
    {
        ...
        public override bool Equals(CosmosNumber cosmosNumber) => cosmosNumber is CosmosUInt32 cosmosUInt32 && Equals(cosmosUInt32);

        public bool Equals(CosmosUInt32 cosmosUInt32) => GetValue() == cosmosUInt32.GetValue();

        public override int GetHashCode() => (int)MurmurHash3.Hash32(GetValue(), 3771427877);

        public int CompareTo(CosmosUInt32 cosmosUInt32) => GetValue().CompareTo(cosmosUInt32.GetValue());

        public override void WriteTo(IJsonWriter jsonWriter) => jsonWriter.WriteUInt32Value(GetValue());
